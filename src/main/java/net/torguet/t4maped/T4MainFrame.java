...
public class T4MainFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        jMenu2 = new JMenu();
        jMenuItemSelect = new JMenuItem();
        jMenuItemCopy = new JMenuItem();
        jMenuItemPaste = new JMenuItem();
        jMenuItemEmpty = new JCheckBoxMenuItem();
        ...
        jMenuItemEmpty.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jMenuItemOther.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new T4MainFrame().setVisible(true);
            }
        });
    }
    ...
    private JMenuItem jMenuItemSelect;
